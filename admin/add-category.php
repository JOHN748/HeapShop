        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="add-category.php" enctype="multipart/form-data">
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group mt-3 mb-2">
                                        ...
                                        <textarea name="category_description" class="form-control" rows="3" value="<?php echo $cat_desc; ?>" placeholder="Write Short Description..." required></textarea>
                                    </div>

                                    <div class="form-group mt-3 mb-3">
                                        <label>Upload Photo</label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input"  name="category_image" id="customFile" required>
