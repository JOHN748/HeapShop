                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Manage Sub-Categories</h4>
                            <!-- Breadcrumb -->
                                ...
                                <div class="table-tools float-right">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <button type="submit" name="multi-sdelete" class="btn btn-danger btn-md float-right ml-3" onClick="return confirm('Are you sure you want to delete?');" >Delete</button>
                                            
                                            <a href="add-sub-category.php" class="btn btn-danger btn-create-users float-right">
                                                <i class="fas fa-plus"></i>&nbsp Add Sub-Category
                                            </a>
                                ...
                                <table id="datatable" class="table table-striped table-hover table-bordered display nowrap"
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th class="text-center">Sub-Category Desc</th>
                                    ...
                                    <tbody>
                                        ...
                                        <form method="post">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="edit-sub-category.php?scat-edit-id=<?php echo $sub_category_detail['id']; ?>" 
