<!-- Datatable JS -->
<script src="admin/assets/libs/datatables/js/jquery.dataTables.min.js"></script>
<script src="admin/assets/libs/datatables/js/dataTables.bootstrap4.min.js"></script>
...
<script src="admin/assets/libs/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="admin/assets/libs/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
